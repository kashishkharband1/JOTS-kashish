...
<?php if(have_rows('content_blocks')):  while ( have_rows('content_blocks') ) : the_row(); ?>
	...
	<header class="bannerimage_sec">
		<div class="sheaderbanner">
			<div class="svg-container" style="background-image: url('<?php echo $image['url']; ?>');">
			  <svg viewBox="0 0 500 500" preserveAspectRatio="xMinYMin meet">
				<path d="M0,170        C175,100 250,240 550,140        L00,800 L0,0 Z" style="stroke: none; fill:white;" ></path>
			  </svg>
			</div>
		</div>
	</header>
...
<div class="elementor-section page_section secondary_pages">
