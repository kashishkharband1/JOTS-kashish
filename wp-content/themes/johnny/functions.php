...
function my_custom_fonts() {
  echo '<style>
    ul.subsubsub span.count,  li#toplevel_page_capsman, li#toplevel_page_pods, .tablenav .one-page .displaying-num, .post-state, .e-dashboard-overview-hide, .metabox-prefs label[for=e-dashboard-overview-hide], .plugin-update-tr.active .update-message.notice.inline.notice-warning.notice-alt, span.update-plugins, td.plugin-title.column-primary span.addons {
